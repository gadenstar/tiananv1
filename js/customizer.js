...
function($) {
    ...
    Pages.prototype.setUserOS = function() {
        var OSName = ""; - 1 != navigator.appVersion.indexOf("Win") && (OSName = "windows"),
    ...
    Pages.prototype.initFormGroupDefault = function() {
        ...
        $("body").on("focus", ".form-group.form-group-default :input",
        function() {
            $(".form-group.form-group-default").removeClass("focused"),
            $(this).parents(".form-group").addClass("focused")
        }),
        $("body").on("blur", ".form-group.form-group-default :input",
        function() {
    ...
    Pages.prototype.initNotificationCenter = function() {
        $(".notification-list .dropdown-menu").on("click",
        function(event) {
            event.stopPropagation()
        }),
        $(".toggle-more-details").on("click",
        function() {
            var p = $(this).closest(".heading");
            p.closest(".heading").children(".more-details").stop().slideToggle("fast",
            function() {
                p.toggleClass("open")
            })
        })
    ...
    Pages.prototype.initView = function() {
        $('[data-navigate="view"]').on("click",
        function(e) {
            e.preventDefault();
            var el = $(this).attr("data-view-port");
            return $(el).toggleClass($(this).attr("data-view-animation")),
            !1
        })
    },
...
function(window) {
    ...
    SelectFx.prototype._createSelectEl = function() {
        ...
        createOptionHTML = function(el) {
            ...
            classes = "",
            link = "";
            return ! el.selectedOpt || this.foundSelected || this.hasDefaultPlaceholder || (classes += "cs-selected ", this.foundSelected = !0),
            el.getAttribute("data-class") && (classes += el.getAttribute("data-class")),
            el.getAttribute("data-link") && (link = "data-link=" + el.getAttribute("data-link")),
    ...
    SelectFx.prototype._initEvents = function() {
        ...
        function(ev) {
            ...
            case 32:
                ev.preventDefault(),
                self._isOpen() && "undefined" != typeof self.preSelCurrent && -1 !== self.preSelCurrent && self._changeOption(),
                self._toggleSelect();
                break;
            case 13:
                ev.preventDefault(),
                self._isOpen() && "undefined" != typeof self.preSelCurrent && -1 !== self.preSelCurrent && (self._changeOption(), self._toggleSelect());
                break;
            case 27:
                ev.preventDefault(),
    ...
    SelectFx.prototype._navigateOpts = function(dir) {
        ...
        var tmpcurrent = "undefined" != typeof this.preSelCurrent && -1 !== this.preSelCurrent ? this.preSelCurrent: this.current; ("prev" === dir && tmpcurrent > 0 || "next" === dir && tmpcurrent < this.selOptsCount - 1) && (this.preSelCurrent = "next" === dir ? tmpcurrent + 1 : tmpcurrent - 1, this._removeFocus(), classie.add(this.selOpts[this.preSelCurrent], "cs-focus"))
    },
    SelectFx.prototype._toggleSelect = function() {
        ...
        if (this._isOpen()) { - 1 !== this.current && (this.selPlaceholder.textContent = this.selOpts[this.current].textContent);
            ...
            var dummy;
            this.selEl.parentNode.querySelector(".dropdown-placeholder") ? dummy = this.selEl.parentNode.querySelector(".dropdown-placeholder") : (dummy = document.createElement("div"), classie.add(dummy, "dropdown-placeholder"), insertAfter(dummy, this.selEl)),
            ...
            mask || (mask = document.createElement("div"), classie.add(mask, "dropdown-mask"), container.appendChild(mask)),
...
function($) {
    ...
    var Progress = function(element, options) {
        ...
        $.fn.circularProgress.defaults, options),
    ...
    Progress.prototype.value = function(val) {
        if ("undefined" != typeof val) {
            ...
            50 >= val ? this.$pie.$right.css("transform", "rotate(" + deg + "deg)") : (this.$pie.css("clip", "rect(auto, auto, auto, auto)"), this.$pie.$right.css("transform", "rotate(180deg)"), this.$pie.$left.css("transform", "rotate(" + deg + "deg)"))
        }
    };
...
function($) {
    ...
    var Notification = function(container, options) {
        ...
        function CircleNotification() {
            ...
            self.options.title && (table += '<p class="bold">' + self.options.title + "</p>"),
            table += "<p>" + self.options.message + "</p></div></div>",
            table += "</div>",
            self.options.showClose && (table += '<button type="button" class="close" data-dismiss="alert">', table += '<span aria-hidden="true">&times;</span><span class="sr-only">Close</span>', table += "</button>"),
        ...
        self.options = $.extend(!0, {},
        $.fn.pgNotification.defaults, options),
        self.container.find(".pgn-wrapper[data-position=" + this.options.position + "]").length ? self.wrapper = $(".pgn-wrapper[data-position=" + this.options.position + "]") : (self.wrapper = $('<div class="pgn-wrapper" data-position="' + this.options.position + '"></div>'), self.container.append(self.wrapper)),
...
function($) {
    ...
    function Plugin(option) {
        return this.each(function() {
            ...
            options = "object" == typeof option && option;
            data || $this.data("pg.portlet", data = new Portlet(this, options)),
    ...
    Portlet.prototype.refresh = function(refresh) {
        ...
        if (refresh) {
            ...
            else if ("bar" == this.options.progress) elem += '<div class="progress progress-small">',
            ...
            elem += "</div>";
                ...
                }), iconNew.addClass("portlet-icon-refresh-lg-" + this.options.progressColor + "-animated"), toggle.append(iconNew)),
                iconOld.addClass("fade"),
                iconNew.addClass("active")
            } else elem += '<div class="progress progress-small">',
            elem += '    <div class="progress-bar-indeterminate progress-bar-' + this.options.progressColor + '"></div>',
            elem += "</div>";
    ...
    $.fn.portlet.noConflict = function() {
        return $.fn.portlet = old,
        this
    },
    $(document).on("click.pg.portlet.data-api", '[data-toggle="collapse"]',
    function(e) {
        var $this = $(this),
    ...
    $(document).on("click.pg.portlet.data-api", '[data-toggle="close"]',
    function(e) {
        var $this = $(this),
        $target = $this.closest(".panel");
        $this.is("a") && e.preventDefault(),
    ...
    $(document).on("click.pg.portlet.data-api", '[data-toggle="refresh"]',
    function(e) {
        var $this = $(this),
        $target = $this.closest(".panel");
        $this.is("a") && e.preventDefault(),
    ...
    $(document).on("click.pg.portlet.data-api", '[data-toggle="maximize"]',
    function(e) {
        var $this = $(this),
        $target = $this.closest(".panel");
        $this.is("a") && e.preventDefault(),
...
function($) {
    ...
    function Plugin(option) {
        return this.each(function() {
            ...
            options = "object" == typeof option && option;
            data || $this.data("pg.quickview", data = new Quickview(this, options)),
    ...
    var Quickview = function(element, options) {
        this.$element = $(element),
        this.options = $.extend(!0, {},
        $.fn.quickview.defaults, options),
        this.bezierEasing = [.05, .74, .27, .99];
        var _this = this;
        $(this.options.notes).on("click", ".list > ul > li",
        function() {
        ...
        $(this.options.notes).on("click", ".list > ul > li .checkbox",
        function(e) {
            e.stopPropagation()
        }),
        $(this.options.notes).on("click", _this.options.backButton,
        function() {
        ...
        $(this.options.notes).on("click", ".toolbar > li > a",
        function() {
    ...
    $(document).on("click.pg.quickview.data-api touchstart", '[data-toggle="quickview"]',
    function(e) {
...
function($) {
    ...
    var Parallax = function(element, options) {
        ...
        $.fn.parallax.defaults, options), this.$coverPhoto = this.$element.find(".cover-photo"), this.$content = this.$element.find(".inner"), this.$coverPhoto.find("> img").length) {
...
function($) {
    ...
    var Sidebar = function(element, options) {
        ...
        $.fn.sidebar.defaults, options), this.bezierEasing = [.05, .74, .27, .99], this.cssAnimation = !0, this.menuClosedCSS, this.menuOpenCSS, this.css3d = !0, this.sideBarWidth = 280, this.sideBarWidthCondensed = 210, this.$sidebarMenu = this.$element.find(".sidebar-menu > ul"), this.$pageContainer = $(this.options.pageContainer), this.$body = $("body"), this.$sidebarMenu.length) {
            ...
            this.$sidebarMenu.find("li > a").on("click",
            function() {
                if ($(this).parent().children(".sub-menu") !== !1) {
                    ...
                    sub.is(":visible") ? ($(".arrow", $(this)).removeClass("open"), sub.slideUp(200,
                    function() {
                        $(this).parent().removeClass("active")
                    })) : ($(".arrow", $(this)).addClass("open"), $(this).parent().addClass("open"), sub.slideDown(200,
                    function() {}))
                }
            }),
            $(".sidebar-slide-toggle").on("click touchend",
            function(e) {
                e.preventDefault(),
                $(this).toggleClass("active");
    ...
    $(document).on("click.pg.sidebar.data-api", '[data-toggle-pin="sidebar"]',
    function(e) {
        e.preventDefault();
        var $target = ($(this), $('[data-pages="sidebar"]'));
        return $target.data("pg.sidebar").togglePinSidebar(),
        !1
    }),
    $(document).on("click.pg.sidebar.data-api touchstart", '[data-toggle="sidebar"]',
    function(e) {
        e.preventDefault();
        var $target = ($(this), $('[data-pages="sidebar"]'));
        return $target.data("pg.sidebar").toggleSidebar(),
        !1
    })
} (window.jQuery),
function($) {
    ...
    Search.prototype.init = function() {
        ...
        this.$searchField.on("keyup",
        function(e) {
            return _this.options.onKeyEnter(_this.$searchField.val()),
            13 == e.keyCode && (e.preventDefault(), _this.options.onSearchSubmit(_this.$searchField.val())),
            $("body").hasClass("overlay-disabled") ? 0 : void 0
        }),
        ...
        $(document).on("keypress.pg.search",
        function(e) {
            _this.keypress(e)
        }),
        $(document).on("keyup",
    ...
    $(document).on("click.pg.search.data-api", '[data-toggle="search"]',
    function(e) {
        var $this = $(this),
