...
class OE_Title_Heading extends AQ_Block {
	...
	function block($instance) {
		...
		echo '
			<div class="heading-title-wrapper uk-text-center uk-animation-fade '.$animation_effect.'" '.$duration_effect.'>
 	...
 	function before_block($instance) {
		extract($instance);
		echo '<div class="animation-wrapper col-md-12 uk-clearfix" style="margin:'.$margin_top.'px 0 '.$margin_bottom.'px;" >';		
	}
